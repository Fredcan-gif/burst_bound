...
func _process(_delta):
	...
	var is_credits = scene_path == "res://Scenes/credits.tscn"
	var should_show = not is_main_menu and not is_tutorial and not is_options and not is_credits and not GameManager.player_dead and not get_tree().paused
